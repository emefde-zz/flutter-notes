...
// in flutter_login/test/authentication/authentication_bloc_test.dart.
...
import 'package:user_repository/src/models/user.dart' as _i4;
...
class MockAuthenticationRepostiory extends _i1.Mock
    implements _i5.AuthenticationRepostiory {
  MockAuthenticationRepostiory() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Stream<_i5.AuthenticationStatus> get status =>
      (super.noSuchMethod(Invocation.getter(#status),
              returnValue: Stream<_i5.AuthenticationStatus>.empty())
          as _i3.Stream<_i5.AuthenticationStatus>);
  @override
